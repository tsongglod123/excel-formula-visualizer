...
Thanks for your interest in contributing! This guide captures the conventions observed across the codebase so contributions land smoothly. It is the contributor-facing companion to the operating rules in `.cline/rules/` and the project knowledge in `memory-bank/`.
